...
const OurPartnersMembership = () => {
  ...
  return (
    <main>
      <div className=" bg-primary">
        ...
        >
          <h1 className="text-white text-2xl w-8/12 font-bold text-center">
            Join the Future of FinTech in Rwanda
          </h1>
          <p className="text-grey text-xs text-center w-8/12">
            Be part of an influential network that is shaping the future of
            financial services in Rwanda and beyond.
          </p>
      ...
      <h1 className="text-center my-6 mt-6 text-primary font-bold text-4xl">
        Our Partners
      </h1>
...
export default OurPartnersMembership;
