  ...
  return (
    <main>
      <div className=" bg-primary">
        ...
        >
          <h1 className="text-white text-2xl md:w-8/12 font-bold text-center">
            Join us to innovate, collaborate, and scale with Rwanda’s most
            dynamic FinTech community
          </h1>
